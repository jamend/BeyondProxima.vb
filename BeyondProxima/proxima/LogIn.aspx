<%@ Page Language="VB" AutoEventWireup="false" Inherits="BeyondProxima.LogInB" Codebehind="LogIn.aspx.vb" %>
...
<body>
    ...
    <div>
        ...
        Username</td><td style="width: 159px">
        <asp:TextBox ID="txtUsername" runat="server" Width="159px" /></td></tr><tr><td style="height: 26px">
            Password</td><td style="width: 159px; height: 26px">
        <asp:TextBox ID="txtPassword" runat="server" TextMode="Password" Width="159px" /></td></tr></table>
