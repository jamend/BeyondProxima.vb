...
function Window(el) {
  ...
  mapName = this.titleBarButtons.useMap.substr(this.titleBarButtons.useMap.lastIndexOf("#") + 1);
  ...
  for (i = 0; i < this.titleBarMap.childNodes.length; i++)
    if (this.titleBarMap.childNodes[i].tagName == "area" || this.titleBarMap.childNodes[i].tagName == "AREA")
